          ...
          <Box p={2}>
            ...
            >
              ...
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/extended-sidebar/overview"
              >
                Extended Sidebar
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/accent-header/overview"
              >
                Accent Header
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/accent-sidebar/overview"
              >
                Accent Sidebar
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/boxed-sidebar/overview"
              >
                Boxed Sidebar
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/collapsed-sidebar/overview"
              >
                Collapsed Sidebar
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/bottom-navigation/overview"
              >
                Bottom Navigation
              </MenuItem>
              <MenuItem
                sx={{ fontWeight: "bold" }}
                component={NavLink}
                to="/blueprints/top-navigation/overview"
              >
                Top Navigation
              </MenuItem>
            </Menu>
